...
export default function PageHero({ title, breadcrumbs, description, backgroundImage }: PageHeroProps) {
  return (
    <section
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <nav aria-label="Breadcrumb" className="mb-4">
          <ol className="flex flex-wrap items-center text-sm text-white/80">
